...
<head>
	...
	<script type="text/javascript" src="/js/js/jqueryvalidate/localization/messages_zh.js"></script>
  ...
  <body class="text-center">
	 ...
	 <f:form action="register" method="post" modelAttribute="user" class="form-signin" id = "form">
		<img class="mb-4" src="/js/images/logo.png" alt="" width="72" height="72">
		  <h1 class="h3 mb-3 font-weight-normal">请注册</h1>
		  
		<f:input path="username" class="form-control" remote="/user/checkuser"/><f:errors path = "username"></f:errors><br/>
